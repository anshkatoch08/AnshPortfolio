...
export function setCharTimeline(
  ...
  if (!landingSection || !aboutSection || !whatIDOSection) {
    console.warn("GSAP: Required sections not found, skipping character timeline setup");
    return;
  }
...
export function setAllTimeline() {
  ...
  if (!careerSection || !careerTimeline || !careerInfoBox || !careerDot) {
    console.warn("GSAP: Career section elements not found, skipping timeline setup");
    return;
  }

  const careerTimelineGsap = gsap.timeline({
    scrollTrigger: {
